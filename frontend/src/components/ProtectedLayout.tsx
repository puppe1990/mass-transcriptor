    ...
    <div className="app-shell">
      <nav className="app-sidebar" aria-label={t("sidebar.ariaLabel")}>
        <div className="app-sidebar__brand">
          <div className="app-sidebar__logo" aria-hidden="true">M</div>
        ...
        <div className="app-sidebar__links">
          <NavLink to={`/t/${tenantSlug}/uploads`} className={({ isActive }) => (isActive ? "active" : undefined)}>
            <NavIcon name="uploads" />
            {t("sidebar.uploads")}
          </NavLink>
          <NavLink to={`/t/${tenantSlug}/jobs`} className={({ isActive }) => (isActive ? "active" : undefined)}>
            <NavIcon name="jobs" />
            {t("sidebar.jobs")}
          </NavLink>
          <NavLink to={`/t/${tenantSlug}/settings`} className={({ isActive }) => (isActive ? "active" : undefined)}>
